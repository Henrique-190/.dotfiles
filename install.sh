...
snaps=(snapd spotify discord vlc "--classic code" "sublime-text --classic" mysql-workbench-community 
"pycharm-professional --classic" "intellij-idea-ultimate --classic" "clion --classic")

apts=(gnome-tweaks wget git mysql-server flameshot gnome-shell-extensions chrome-gnome-shell
gettext make gir1.2-gmenu-3.0 gnome-menus libgettextpo-dev)
